...
const Spinning = () => {
	...
	useGSAP(() => {
		const titleSplit = new GSAPSplitText(titleRef.current, {
			type: "chars",
		});
	...
	return (
		...
		>
			...
			<div className="flex justify-center items-center w-screen">
				...
				>
					The spinning division consists of 175,000 spindles, most of
					which are recently inducted. All of the machinery is state
					of the art from leading machinery manufacturers such as
					Rieter, Toyoda and Marzoli.
				</p>
				<Image
					ref={img1Ref}
